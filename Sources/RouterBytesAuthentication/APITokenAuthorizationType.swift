...
public protocol APITokenAuthorizationType {
    func authorizedRequest(request: HTTPRequest, with apiToken: some APITokenType) async throws -> HTTPRequest
...
extension RouterBytes.AuthorizationType: APITokenAuthorizationType {
    public func authorizedRequest(request: HTTPRequest, with apiToken: some APITokenType) -> HTTPRequest {
        switch self {
